 ...
 *
 *    This application provides a few unit tests of the cut library
 *    module.
 *
 *    This module is a wrapper for the structures in the XPCCUT library,
 *    which is written in C.  This unit-test application does not need to
...
#define CUTPP_TEST_VERSION       1.0.5
