 ...
 * \updates       2008-03-27 to 2011-10-29
 * \version       $Revision$
 * \license       $XPC_SUITE_GPL_LICENSE$
 *
 *    Provides the declarations for the xpc::cut_status class.
 *
 *    This class provides a container for the current status of a unit-test
 *    application.
 *
 *    Please see the xpc::cut_status class description for details.
 *
 *    Also see the cut_status.cpp module and the cut_status.hpp modules
...
/******************************************************************************
 * class cut_options foward reference
 *------------------------------------------------------------------------*//**
 *
...
/******************************************************************************
 * class cut_white_box foward reference
 *------------------------------------------------------------------------*//**
 *
