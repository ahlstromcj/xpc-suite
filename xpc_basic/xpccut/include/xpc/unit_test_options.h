 ...
 *    unit-test framework.
 *
 *    The unit_test_options_t structure rovides part of a fairly capable
 *    unit-test framework.
 *
 *    See the C module fnd the unit_test_options_t description or full
 *    details.
 *
 *//*-------------------------------------------------------------------------*/
...
/******************************************************************************
 * XPCCUT_TESTGROUP_MAX
 *------------------------------------------------------------------------*//**
 *
 *    Maximum number of unit-test groups, the highest group that can be
 *    selected.
 *
 *    The actual value is determined by the --group command-line option.
 *
 *//*-------------------------------------------------------------------------*/
 ...
 *    selected.
 *
 *    The actual value is determined by the --case command-line option.
 *
 *//*-------------------------------------------------------------------------*/
 ...
 *    selected.
 *
 *    The actual value is determined by the --sub-test command-line option.
 *
 *//*-------------------------------------------------------------------------*/
...
/******************************************************************************
 * XPCCUT_SLEEPTIME_MAX
 *------------------------------------------------------------------------*//**
 *
 *    Maximum amount of time that a unit-test application can sleep between
 *    tests.
 *
 *    The actual value is determined by the --sleep-time command-line
 ...
 *------------------------------------------------------------------------*//**
 *
 *    Default value setting for the m_Is_Verbose ("--verbose") field.
 *
 *    The default value is as if the "--no-verbose" option had been
 *    specified.
 *
 *//*-------------------------------------------------------------------------*/
 ...
 *    field.
 *
 *    The default value is as if the "--no-step-numbers" option had been
 *    specified.
 *
 *//*-------------------------------------------------------------------------*/
...
typedef struct
{
    ...
    *    --no-text-synch option.
    *
    *    The default value of this option is given by the XPCCUT_TEXT_SYNCH
    *    macro.
    *
    * \accessor
    ...
    *    where a test fails.
    *
    *    This value is set by the --show-step-numbers option, and unset by
    *    the --no-show-step-numbers option.
    *
    *    The default value of this option is given by the
    *    XPCCUT_SHOW_STEP_NUMBGERS macro.
    *
    * \accessor
    ...
    *    --no-show-progress option.
    *
    *    The default value of this option is given by the
    *    XPCCUT_SHOW_PROGRESS macro.
    *
    * \accessor
    ...
    *    --no-stop-on-error option.
    *
    *    The default value of this option is given by the
    *    XPCCUT_STOP_ON_ERROR macro.
    *
    * \accessor
    ...
    *
    *    The default value of this option is given by the XPCCUT_BATCH_MODE
    *    macro.
    *
    * \accessor
   ...
   /**
    *    Provides a flag for allowing the user to interact with the unit
    *    test.
    *
    *    This option can be useful for trying different values, or for
    *    running applications that are necessarily interactive.
    *
    *    This value is set by the --interactive option, and unset by the
    *    --no-interactive option.
    *
    *    The default value of this option is given by the XPCCUT_INTERACTIVE
    *    macro.
    *
    * \accessor
    ...
    *
    *    This value is set by the --beeps option, and unset by the
    *    --no-beeps option.
    *
    *    The default value of this option is given by the XPCCUT_BEEP
    *    macro.
    *
    * \accessor
   ...
   /**
    *    Provides a flag for generating summary output about the
    *    unit-test.
    *
    *    This option is useful for showing a list of all the unit-test
    *    groups, cases, and sub-tests, and their names.
    *
    *    This value is set by the --summarize option, and unset by the
    *    --no-summarize option.
    *
    *    The default value of this option is given by the XPCCUT_SUMMARIZE
    *    macro.
    *
    * \accessor
   ...
   /**
    *    Provides a flag for requiring the usage of sub-tests.
    *
    *    This option is useful for forcing the programmer to be diligent in
    *    using unit_test_status_next_subtest(), but currently this flag
    *    is false by default.
    *
    *    This value is set by the --require-sub-tests option, and unset by
    *    the --no-require-sub-tests option.
    *
    *    The default value of this option is given by the
    *    XPCCUT_NEED_SUBTESTS macro.
    *
    * \accessor
   ...
   /**
    *    Provides a flag for pausing between each case.
    *
    *    Thus, this option requires that a user be present to interact with
    *    the unit-test application.
    *
    *    This value is set by the --case-pause option, and unset by the
    *    --no-case-pause option.
    *
    *    The default value of this option is given by the XPCCUT_CASE_PAUSE
    *    macro.
    *
    * \accessor
   ...
   /**
    *    Provides a flag for running only a single test group.
    *
    *    A "test group" is a small collection of related tests.  For
    *    example, a test group may be a collection of tests of all of the
    *    functions in a given class in a library.
    *
    *    This value is set by the --group option.  To unset this option, use
    *    an option argument value of zero ("0").
    *
    *    The default value of this option is given by the
    *    XPCCUT_NO_SINGLE_GROUP macro.
    *
    * \accessor
    ...
    *
    *    This value is set by the --group option, if the value does not
    *    start with an integer.  To unset this value, pass an empty string
    *    as its value: "".
    *
    *    The default value of this option is given by the empty string ("").
    *
    * \accessor
   ...
   /**
    *    Provides a flag for running only a single test case.
    *
    *    A "test case" is a single unit-test.  A "test case" is equivalent
    *    to a unit-test.
    *
    *    For example, a test case may cover all of the sub-tests used for
    *    testing a single function in a single class.
    *
    *    This value is set by the --case option.  To unset this option, use
    *    an option argument value of zero ("0").
    *
    *    The default value of this option is given by the
    *    XPCCUT_NO_SINGLE_CASE macro.
    *
    * \accessor
   ...
   /**
    *    Provides a value for running only a single subtest.
    *
    *    A sub-test is a small test, that usually provides a small variation
    *    on parameter input.  Usually, a test case provides a number of
    *    sub-tests that may, for example, test all of the corner conditions
    *    for a function.
    *
    *    This value is set by the --sub-test option.  To unset this option,
    *    use an option argument value of zero ("0").
    *
    *    The default value of this option is given by the
    *    XPCCUT_NO_SINGLE_SUB_TEST macro.
    *
    * \accessor
   ...
   /**
    *    Provides a value for sleeping between tests.
    *
    *    Sometimes, the resources created for a unit test may take a little
    *    time to be released by the operating system, and the next test may
    *    have to wait for the previous test's resources to be put to bed,
    *    lest the current test fail even if it is correct.
    *
    *    This value is in milliseonds.
    *
    *    This value is set by the --sleep-time option.  It is unset by
    *    providing a time-value of zero ("0").
    *
    *    The default value of this option is given by the
    *    XPCCUT_TEST_SLEEP_TIME macro.
    *
    * \accessor
...
/******************************************************************************
 * Global unit_test_options_t functions
 *----------------------------------------------------------------------------
 *
