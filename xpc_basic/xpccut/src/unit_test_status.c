 ...
 * \updates       2008-03-07 to 2011/12/28
 * \version       $Revision$
...
/******************************************************************************
 * unit_test_status_t default C constructor
 *------------------------------------------------------------------------*//**
 *
...
/******************************************************************************
 * unit_test_status_t options C constructor
 *------------------------------------------------------------------------*//**
 *
 ...
 *------------------------------------------------------------------------*//**
 *
 *    Prints a message, and waits for a user's response before performing
 *    the next unit-test.
 *
 *    Call this function only for unit-tests that require some kind of user
 *    interaction \e before they can execute.
 *
