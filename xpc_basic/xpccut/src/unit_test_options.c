...
/******************************************************************************
 * unit_test_options_t default C constructor
 *------------------------------------------------------------------------*//**
 *
...
/******************************************************************************
 * unit_test_options_t principal C constructor
 *------------------------------------------------------------------------*//**
 *
...
\endverbatim
          *
          *    Non-unit-test options have to be allowed in this loop, since
          *    we may be passing the same command line to a number of
          *    different parssing functions.
          *
          *    Hence, there is no checking for illegal options at this time.
          */
...
/******************************************************************************
 * unit_test_options_help text [static]
 *------------------------------------------------------------------------*//**
 *
...
/******************************************************************************
 * unit_test_options_is_show_values_set()
 *------------------------------------------------------------------------*//**
 *
 ...
 *------------------------------------------------------------------------*//**
 *
 *    Provides the value of m_Single_Test_Group.
 *
 *    Also, as a sanity check, the value of the item is sanity checked.
 *    This can help detect situations where the unit_test_status_t structure
 *    has not been initialized.  We assume that the value should be 0 (in
 *    case no single group of tests is selected), greater than 0, or less
 *    than a million.  (That last restriction might be considered an \e
 *    insane sanity check!)
 *
 * \return
