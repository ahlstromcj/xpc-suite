...
syn keyword XPCC xpc_errprint_func xpc_good_pointer
syn keyword XPCC XPC_PACKAGE XPC_VERSION XPC_VERSION_DATE XPC_API_VERSION
syn keyword XPCC XPC_VERSION_DATE_SHORT
...
syn keyword XPCC set_invalid_socket
...
syn keyword cTodo contained question recursive return ref reference references
...
syn keyword cTodo contained unittests unix update updates usage
